...
var taskInput = document.querySelector(".centered__input");//Add a new task.
var addButton = document.querySelector(".centered__btn");//first button
...
var createNewTaskElement = function(taskString) {
    ...
    deleteButton.className = "centered__btn centered__btn_delete";
...
//select ListItems children
    ...
    var editButton = taskListItem.querySelector(".centered__btn_edit");
    var deleteButton = taskListItem.querySelector(".centered__btn_delete");
